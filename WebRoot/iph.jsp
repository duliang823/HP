...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		var path="http://182.148.122.14:10015/videostream.cgi?loginuse=admin&loginpas=123456";	 	//sarfi 和 firefox 、chorem  主页面用这个 
  ...
  <div id="videoline">实时视频(前池坝体)</div>
  <div id="main-video">
 	 <img id="img1" width="640" height="480" src="http://182.148.122.14:10015/videostream.cgi?loginuse=admin&loginpas=123456"> 
 	</img>	    
   </div>
   <div id="ov">
   	<a href="http://182.148.122.14:10000/HP/iphkf.jsp"  style="color:lightblue;">库房视频监控</a><br>
   </div>
